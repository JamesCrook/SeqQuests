...
The alpha carbon atoms are drawn with a flattened backbone ribbon. This is done for all alpha carbons, irrespective of secondary structure designations. The ribbon can be featureless, or you can show arrows of different widths. You can show highlight alpha carbon positions and show a node near the backbone nitrogen that indicates ribbon direction if arrows are not used.

The coulouring of the backbone (and sidechains) can be by different properties such as hydrophobicity and charge.  
