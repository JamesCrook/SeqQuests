...
## Strengths
* The AI can pay attention to many details of the data files, using pfam, eggNOG, InterPro, Alternative products and FT records. It can also go beyond and see that from the title of cited papers a family resemblence is known already, including taking account of older terminology and naming.
...
* When looking for eggNOG on line, AI will keep findng the drink.
