...
**Description:** A Metal-accelerated (GPU) implementation of the Needleman-Wunsch-Smith algorithm. It performs massive parallel searches of a query sequence against a database, producing protein similarity data - a list of high scoring links.
...
*   **`nws_align.py`**: A pure Python implementation of Smith-Waterman. Useful for debugging and verifying scores against the Metal implementation.
